    ...
    <div className="flex  flex-row border-16 font-serif ">
          ...
          <div className=" mt-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <p className="text-xl font-light text-black">
                ...
                <Link to="/login">
                  {" "}
                  <button className="border-2 border-pink-700 w-32 h-8 rounded-md text-pink-700 font-semi-bold hover:bg-cyan-400">
                    Log In
                  </button>
                </Link>
              </p>
      ...
      <div className="bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 ... w-1/2">
        ...
        <p className=" text-2xl w-[550px] ml-20 text-white mt-16">
          Ready to embark on a journey with us? Your adventure begins here. By
          registering today, you're not just creating an account; you're joining
          a vibrant and welcoming community dedicated to [mention your
          platform's purpose or mission, e.g., 'transforming online learning' or
          'revolutionizing healthcare access']. We believe in making things
          easy, enjoyable, and empowering. Our platform is designed to provide
          you with the tools and resources you need to [mention the benefits,
          e.g., 'unlock your learning potential' or 'take control of your
          health']. So why wait? Join us and experience the future of [mention
          your platform's field, e.g., 'education' or 'healthcare'] firsthand.
          Let's build a brighter future together, starting right now
        </p>
      </div>
    </div>
  );
